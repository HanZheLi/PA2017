...
make_group(gp1,
    ...
    EXW(and,1), EXW(sub,1), EX(xor), EX(cmp))
...
opcode_entry opcode_table [512] = {
  ...
  /* 0x30 */	IDEXW(G2E,xor,1), IDEXW(G2E,xor,0),IDEXW(G2E,xor,0),IDEXW(G2E,xor,0),
  ...
  /* 0x54 */	IDEX(r,push), IDEXW(r,push,4), IDEX(r,push), IDEX(r,push),
